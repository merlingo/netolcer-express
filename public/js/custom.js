...
jQuery(function ($) { "use strict";
	...
	function initialize() {
		...
		var myLatLng = new google.maps.LatLng(39.9557477, 32.6943313,17);
...
//benim ekledigim
//login modal i icin
$('#uyelik-modal').find('input, textarea').on('keyup blur focus', function (e) {
...
$('#uyelik-modal > .tab a').on('click', function (e) {
